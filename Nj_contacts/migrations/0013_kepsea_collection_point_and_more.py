# Generated by Django 4.2.2 on 2023-07-16 16:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Nj_contacts', '0012_rename_collection_points_kcpe_collection_point'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='kcpe_collection_point',
            name='route',
        ...
        migrations.AlterField(
            model_name='kcpe_collection_point',
            name='school_name',
            field=models.CharField(max_length=200, unique=True, validators=[django.core.validators.RegexValidator(code='invalid_school_name', message='Only letters are allowed', regex="^[A-Za-z\\s.'&-]+$")]),
        ),
    ]
